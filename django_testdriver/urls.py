...
import settings as django-testdriver_settings
...
urlpatterns = patterns('',
    ...
    (r'^test/(?P<path>.*)$', 'django.views.static.serve',
        {'document_root': django-testdriver_settings.MEDIA_ROOT }),

    url(r'^coverage/$', 'django_testdriver.views.coverage_view', name='coverage_view'),

    (r'^coverage/(?P<path>.*)$', 'django.views.static.serve',
        {'document_root': os.path.join(django-testdriver_settings.JSTESTDRIVER_OUTPUT, 'html') }),
)
